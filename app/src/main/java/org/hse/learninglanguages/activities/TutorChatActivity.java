...
import org.hse.learninglanguages.databinding.ActivityTutorChatBinding;
...
public class TutorChatActivity extends BaseActivity implements ConversionListener {
    ...
    private void setListeners(){
        binding.startSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                RecentConversationsAdapter conversationsAdapter = new RecentConversationsAdapter(conversations, TutorChatActivity.this, preferenceManager.getBoolean(Constants.KEY_STUDENT_LOGIN));
        ...
        binding.settings.setOnClickListener(v ->
                startActivity(new Intent(getApplicationContext(),TutorSettingsActivity.class)));
        ...
        if(value != null){
            for(DocumentChange documentChange : value.getDocumentChanges()){
                if(documentChange.getType() == DocumentChange.Type.ADDED){
                    ...
                    if(preferenceManager.getString(Constants.KEY_TUTOR_ID).equals(senderId)){
